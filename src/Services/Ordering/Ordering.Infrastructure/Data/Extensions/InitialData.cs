...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "jane", "jane@gmail.com"),
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("jane", "doe", "jane@gmail.com", "Saltwater No:4", "Australia", "Victoria", "3000");
            var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:100", "Australia", "NSW", "2147");
